    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <form action="{{ route('admin.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                style="background-image: url({{ $product->thumb_image ? asset('storage/' . $product->thumb_image) : '' }});
...
@push('scripts')
    ...
    $('.image-preview').css({
        'background-image': 'url({{ $product->thumb_image ? asset("storage/" . $product->thumb_image) : '' }})',
        'background-size': 'cover',
